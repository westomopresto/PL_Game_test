...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAllowParallelEntryStates_MetaData[];
#endif
		static void NewProp_bAllowParallelEntryStates_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowParallelEntryStates;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraphNode_StateMachineEntryNode_Statics::NewProp_bAllowParallelEntryStates_MetaData[] = {
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USMGraphNode_StateMachineEntryNode_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraphNode_StateMachineEntryNode_Statics::NewProp_bAllowParallelEntryStates,
	};
	...
	IMPLEMENT_CLASS(USMGraphNode_StateMachineEntryNode, 295934059);
	...
	IMPLEMENT_CLASS(USMGraphK2Node_StateMachineEntryNode, 2070525428);
