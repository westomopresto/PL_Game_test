...
static struct FScriptStruct_SMExtendedRuntime_StaticRegisterNativesFSMTextNodeWidgetInfo
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::Struct_MetaDataParams[] = {
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_EditableTextStyle_MetaData[] = {
		{ "Category", "Style" },
		{ "ModuleRelativePath", "Public/Properties/SMTextNodeWidgetInfo.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_EditableTextStyle = { "EditableTextStyle", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSMTextNodeWidgetInfo, EditableTextStyle), Z_Construct_UScriptStruct_FInlineEditableTextBlockStyle, METADATA_PARAMS(Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_EditableTextStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_EditableTextStyle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_WrapTextAt_MetaData[] = {
		{ "Category", "Style" },
		{ "ModuleRelativePath", "Public/Properties/SMTextNodeWidgetInfo.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_WrapTextAt = { "WrapTextAt", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSMTextNodeWidgetInfo, WrapTextAt), METADATA_PARAMS(Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_WrapTextAt_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_WrapTextAt_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_EditableTextStyle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::NewProp_WrapTextAt,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::ReturnStructParams = {
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo()
	{
		...
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FSMTextNodeWidgetInfo_Hash() { return 1343315604U; }
