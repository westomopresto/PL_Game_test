...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USMGraphNode_StateMachineStateNode_Statics::NewProp_bReuseReference = { "bReuseReference", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USMGraphNode_StateMachineStateNode), &Z_Construct_UClass_USMGraphNode_StateMachineStateNode_Statics::NewProp_bReuseReference_SetBit, METADATA_PARAMS(Z_Construct_UClass_USMGraphNode_StateMachineStateNode_Statics::NewProp_bReuseReference_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraphNode_StateMachineStateNode_Statics::NewProp_bReuseReference_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USMGraphNode_StateMachineStateNode, 947897766);
