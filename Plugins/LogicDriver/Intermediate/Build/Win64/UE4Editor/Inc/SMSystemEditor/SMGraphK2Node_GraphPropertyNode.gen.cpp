...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RuntimeGraphProperty_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_RuntimeGraphProperty;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_RuntimeGraphProperty_MetaData[] = {
		{ "ModuleRelativePath", "Private/Graph/Nodes/PropertyNodes/SMGraphK2Node_GraphPropertyNode.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_RuntimeGraphProperty = { "RuntimeGraphProperty", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMGraphK2Node_GraphPropertyNode, RuntimeGraphProperty), Z_Construct_UScriptStruct_FSMGraphProperty_Runtime, METADATA_PARAMS(Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_RuntimeGraphProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_RuntimeGraphProperty_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_GraphProperty_MetaData[] = {
		{ "Category", "Graph Property" },
		{ "ModuleRelativePath", "Private/Graph/Nodes/PropertyNodes/SMGraphK2Node_GraphPropertyNode.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_GraphProperty = { "GraphProperty", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMGraphK2Node_GraphPropertyNode, GraphProperty), Z_Construct_UScriptStruct_FSMGraphProperty, METADATA_PARAMS(Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_GraphProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_GraphProperty_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_RuntimeGraphProperty,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::NewProp_GraphProperty,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMGraphK2Node_GraphPropertyNode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMGraphK2Node_GraphPropertyNode, 2352879947);
