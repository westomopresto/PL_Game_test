...
{
	return LOCTEXT("StartStateNode", "Begin State Instance");
}
...
{
	return LOCTEXT("UpdateStateNode", "Update State Instance");
}
...
{
	return LOCTEXT("StopStateNode", "End State Instance");
}
...
{
	return LOCTEXT("StateMachineStartNode", "Root State Machine Start (State Instance)");
}
...
{
	return LOCTEXT("StateMachineStopNode", "Root State Machine Stop (State Instance)");
}
...
{
	return LOCTEXT("InstanceCanEnterTransition", "Can Instance Enter Transition");
}
...
{
	return LOCTEXT("InstanceTransitionEntered", "On Instance Transition Entered");
}
...
{
	return LOCTEXT("InstanceTransitionInitialized", "On Instance Transition Initialized");
}
...
{
	return LOCTEXT("InstanceTransitionShutdown", "On Instance Transition Shutdown");
}
...
{
	return LOCTEXT("ConduitInstanceCanEnterTransition", "Can Instance Enter Transition");
}
...
{
	return LOCTEXT("InstanceConduitEntered", "On Instance Conduit Entered");
}
...
{
	return LOCTEXT("InstanceConduitInitialized", "On Instance Conduit Initialized");
}
...
{
	return LOCTEXT("InstanceConduitShutdown", "On Instance Conduit Shutdown");
}
