...
{
	const UEdGraph* OwningGraph = FSMBlueprintEditorUtils::FindTopLevelOwningGraph(GetGraph());
	...
	FSMBlueprintEditorUtils::GetAllNodesOfClassNested<USMGraphK2Node_RuntimeNodeContainer>(OwningGraph, ResultNodes);
